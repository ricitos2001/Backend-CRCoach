...
public class SnapshotController {
    ...
    @Operation(summary = "Obtener snapshots por tag de jugador", 
               description = "Obtiene todas las instantáneas capturadas de un jugador ordenadas por fecha descendente.")
    public ResponseEntity<Page<SnapshotResponseDTO>> getSnapshotsByPlayerTag(
    ...
    @Operation(summary = "Obtener snapshots por ID de perfil de jugador", 
               description = "Obtiene todas las instantáneas capturadas de un perfil de jugador por su ID.")
    public ResponseEntity<Page<SnapshotResponseDTO>> getSnapshotsByPlayerProfileId(
    ...
    @Operation(summary = "Obtener snapshot por ID", 
               description = "Obtiene una instantánea específica por su ID.")
    public ResponseEntity<SnapshotResponseDTO> getSnapshotById(
    ...
    public ResponseEntity<Page<SnapshotResponseDTO>> getSnapshotsByDateRange(
            @PathVariable String playerTag,
    ...
    @Operation(summary = "Eliminar snapshots antiguas", 
               description = "Elimina todas las instantáneas más antiguas que X días.")
    public ResponseEntity<String> deleteOldSnapshots(

    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/battles", "/api/v1/cards", "/api/v1/goals", "/api/v1/player-cards", "/api/v1/player-decks", "/api/v1/player-profiles", "/api/v1/sessions", "/api/v1/snapshots", "/api/v1/users").hasAnyRole("USER")
